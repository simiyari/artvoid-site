...
## Summary
- 118 nodes · 112 edges · 13 communities (10 shown, 3 thin omitted)
...
2. `CLAUDE.md — مغز فرمانده پروژه Artvoid` - 10 edges
3. `ROADMAP.md — مسیر ساخت سایت Artvoid با Claude Code` - 9 edges
4. `DESIGN.md — سیستم طراحی Artvoid` - 8 edges
5. `PROGRESS.md — حافظه پیشرفت پروژه Artvoid` - 6 edges
6. `SHOWCASE.md — ایده‌های نمایش زنده UI/UX در سایت Artvoid` - 6 edges
7. `سابقه کارهای انجام‌شده` - 5 edges
8. `Artvoid — artvoid.ir` - 4 edges
9. `۱. رنگ‌ها` - 4 edges
10. `scripts` - 4 edges
...
## Knowledge Gaps
- **78 isolated node(s):** `وضعیت فعلی`, `تصمیمات قطعی‌شده`, `تصمیمات باز (از کاربر بپرس وقتی به آن رسیدی)`, `مرحله ۰ — بوت‌استرپ (خودکار توسط Claude Code)`, `مرحله ۱ — اسکلت پروژه` (+73 more)
