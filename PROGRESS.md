...
### مرحله ۳ — صفحات اصلی
- [x] **خانه** — ۱۴۰۵/۰۴/۲۳ — Hero تمام‌قد با ورود پلکانی + نشانه اسکرول انیمیت، خدمات (۳ کارت hover-lift)، نمونه‌کار برجسته (کارت ادیتوریال Ganjriz/IDI با نام Switzer)، فرآیند ۴ قدمی، CTA بلوک معکوس (bg-ink) — Navbar/Footer به layout ریشه منتقل شد + title template
